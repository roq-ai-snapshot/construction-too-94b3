  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="With Construction Tool Rental v1, individual customers unlock the power to rent construction tools from a central supplier with multiple outlets. Your project, our tools."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`With Construction Tool Rental v1, individual customers unlock the power to rent construction tools from a central supplier with multiple outlets. Your project, our tools.`}
            </Text>
            <Box
